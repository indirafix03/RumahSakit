            ...
            <div class="container position-relative">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <p class="page-subtitle mb-0">Buat layanan poli baru untuk sistem</p>
                    </div>
        ...
        <div class="container">
            <div class="section-card">
                ...
                <div class="section-body">
                    <form action="{{ route('admin.polis.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group-custom mb-4">
                                    ...
                                    <input type="text" class="form-control-custom @error('nama_poli') is-invalid-custom @enderror" 
                                           ...
                                           placeholder="Masukkan nama poli (contoh: Poli Umum, Poli Gigi, dll)" required>
                                    @error('nama_poli')
                            ...
                            <div class="col-md-12">
                                <div class="form-group-custom mb-4">
                                    ...
                                    <textarea class="form-control-custom @error('deskripsi') is-invalid-custom @enderror" 
                                              ...
                                              placeholder="Deskripsi lengkap tentang layanan poli..." required>{{ old('deskripsi') }}</textarea>
                                    @error('deskripsi')
                                        <div class="invalid-feedback-custom">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-12">
                                <div class="form-group-custom mb-4">
                                    <label for="ikon" class="form-label-custom">
                                        <i class="fas fa-image me-2"></i>Ikon/Gambar Poli
                                        <span class="text-danger">*</span>
                                    </label>
                                    <div class="file-upload-wrapper">
                                        ...
                                        <div class="file-upload-area" id="file-upload-area">
                                            <div class="file-upload-content">
                                                ...
                                                <p class="file-upload-subtext">Format: JPEG, PNG, JPG, GIF, SVG. Maksimal 2MB.</p>
                                            </div>
                                        </div>
                                    </div>
                                    @error('ikon')
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-3">
                                    ...
                                    <button type="submit" class="btn btn-primary-custom">
                                        <i class="fas fa-save me-2"></i>Simpan Poli Baru
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    function handleFileSelect(file) {
        if (file) {
            ...
            reader.onload = function(ev) {
                imagePreview.innerHTML = `<img src="${ev.target.result}" class="img-fluid" alt="Preview">`;
